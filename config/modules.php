...
use App\Extensions\Module\DatabaseActivator;
...
return [
    ...
    'paths' => [
        ...
        */
        'generator' => [
            ...
            'notifications' => ['path' => 'app/Contracts', 'generate' => false],
    ...
    */
    'composer' => [
        'vendor' => env('MODULE_VENDOR', 'jasonc'),
        'author' => [
            'name' => env('MODULE_AUTHOR_NAME', 'Jason.Chen'),
            'email' => env('MODULE_AUTHOR_EMAIL', 'jason.c@gmail.com'),
        ],
    ...
    */
    ...
    'activator' => PHP_OS == 'Linux' ? 'database' : 'file',
];
