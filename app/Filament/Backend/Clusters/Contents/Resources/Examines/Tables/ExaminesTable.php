...
namespace App\Filament\Backend\Clusters\Contents\Resources\Examines\Tables;
        ...
        return $table
            ...
            ->recordActions([
                Actions\Action::make('audit')
                    ...
                    ->action(function(array $data, Examine $record, Actions\Action $action) {
