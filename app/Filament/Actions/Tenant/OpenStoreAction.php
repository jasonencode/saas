...
class OpenStoreAction extends Action
{
    ...
    protected function setUp(): void
    {
        ...
        $this->fillForm(function (Tenant $tenant) {
            return [
                'store_name' => $tenant->storeConfigure->store_name ?? $tenant->name,
                'auto_complete_days' => $tenant->storeConfigure->auto_complete_days ?? AutoCompleteDays::Days7,
                'order_expired_minutes' => $tenant->storeConfigure->order_expired_minutes ?? 10,
            ];
        });
