...
namespace App\Admin\Clusters\Settings\Resources\ModuleResource\Pages;

use App\Admin\Clusters\Settings\Resources\ModuleResource;
    ...
    protected function getActions(): array
    {
        return [
            ...
            Action::make('install')
                ...
                ->visible(fn() => userCan('install', self::$resource::getModel()))
