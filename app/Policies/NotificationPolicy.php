...
class NotificationPolicy extends Policy
{
    ...
    #[PolicyName('永久删除')]
    public function forceDelete(Authenticatable $user, Notification $notification): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
    ...
    #[PolicyName('恢复')]
    public function restore(Authenticatable $user, Notification $notification): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
