...
class ContentCategoryPolicy extends Policy
{
    ...
    public function view(Authenticatable $user, ContentCategory $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
    ...
    public function update(Authenticatable $user, ContentCategory $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }

    #[PolicyName('删除', type: PolicyType::Button)]
    public function delete(Authenticatable $user, ContentCategory $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
    ...
    public function upgradeSort(Authenticatable $user, ContentCategory $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
}
