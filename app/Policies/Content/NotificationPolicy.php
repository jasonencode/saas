...
{
    protected string $modelName = '系统通知';
    ...
    public function view(Authenticatable $user, Notification $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
    ...
    public function update(Authenticatable $user, Notification $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }

    #[PolicyName('删除', type: PolicyType::Button)]
    public function delete(Authenticatable $user, Notification $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
