...
class ContentTagPolicy extends Policy
{
    protected string $modelName = '内容标签';
    ...
    public function view(Authenticatable $user, ContentTag $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
    ...
    public function update(Authenticatable $user, ContentTag $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }

    #[PolicyName('删除', type: PolicyType::Button)]
    public function delete(Authenticatable $user, ContentTag $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
    ...
    public function upgradeSort(Authenticatable $user, ContentTag $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
}
