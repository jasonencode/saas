...
class WithdrawOrderPolicy extends Policy
{
    protected string $modelName = '提现记录';
    ...
    public function view(Authenticatable $user, WithdrawOrder $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
    ...
    public function update(Authenticatable $user, WithdrawOrder $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }

    #[PolicyName('删除', type: PolicyType::Button)]
    public function delete(Authenticatable $user, WithdrawOrder $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
