...
class RechargeOrderPolicy extends Policy
{
    protected string $modelName = '充值记录';
    ...
    public function view(Authenticatable $user, RechargeOrder $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
    ...
    public function update(Authenticatable $user, RechargeOrder $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }

    #[PolicyName('删除', type: PolicyType::Button)]
    public function delete(Authenticatable $user, RechargeOrder $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
