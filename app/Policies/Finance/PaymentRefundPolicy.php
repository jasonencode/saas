...
class PaymentRefundPolicy extends Policy
{
    ...
    public function view(Authenticatable $user, PaymentRefund $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
    ...
    public function update(Authenticatable $user, PaymentRefund $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }

    #[PolicyName('删除', type: PolicyType::Button)]
    public function delete(Authenticatable $user, PaymentRefund $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
