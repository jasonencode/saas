...
{
    protected string $modelName = '订阅套餐';
    ...
    public function view(Authenticatable $user, Plan $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
    ...
    public function update(Authenticatable $user, Plan $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }

    #[PolicyName('删除', type: PolicyType::Button)]
    public function delete(Authenticatable $user, Plan $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
