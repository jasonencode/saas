...
{
    protected string $modelName = 'ChapterPolicy权限名称';
    ...
    #[PolicyName('导入选手', '')]
    public function importPlayer(Authenticatable $user)
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }

    #[PolicyName('下载海报', '')]
    public function downloadPoster(Authenticatable $user)
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }

    #[PolicyName('更新海报', '')]
    public function updatePoster(Authenticatable $user)
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
