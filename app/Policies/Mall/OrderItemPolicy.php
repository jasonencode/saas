...
{
    protected string $modelName = '订单明细';
    ...
    public function view(Authenticatable $user, OrderItem $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
    ...
    public function update(Authenticatable $user, OrderItem $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }

    #[PolicyName('删除', type: PolicyType::Button)]
    public function delete(Authenticatable $user, OrderItem $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
