...
class DeliveryPolicy extends Policy
{
    ...
    public function view(Authenticatable $user, Delivery $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
    ...
    public function update(Authenticatable $user, Delivery $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }

    #[PolicyName('删除', type: PolicyType::Button)]
    public function delete(Authenticatable $user, Delivery $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
    ...
    public function upgradeSort(Authenticatable $user, Delivery $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
