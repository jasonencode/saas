...
class PickupPointPolicy extends Policy
{
    protected string $modelName = '自提点';
    ...
    public function view(Authenticatable $user, PickupPoint $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
    ...
    public function update(Authenticatable $user, PickupPoint $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }

    #[PolicyName('删除', type: PolicyType::Button)]
    public function delete(Authenticatable $user, PickupPoint $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
