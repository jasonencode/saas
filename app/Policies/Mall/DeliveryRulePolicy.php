...
class DeliveryRulePolicy extends Policy
{
    ...
    public function view(Authenticatable $user, DeliveryRule $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
    ...
    public function update(Authenticatable $user, DeliveryRule $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }

    #[PolicyName('删除', type: PolicyType::Button)]
    public function delete(Authenticatable $user, DeliveryRule $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
    ...
    public function upgradeSort(Authenticatable $user, DeliveryRule $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
}
