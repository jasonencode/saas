...
class StoreConfigurePolicy extends Policy
{
    ...
    public function view(Authenticatable $user, StoreConfigure $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
    ...
    public function update(Authenticatable $user, StoreConfigure $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }

    #[PolicyName('删除', type: PolicyType::Button)]
    public function delete(Authenticatable $user, StoreConfigure $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
