...
{
    protected string $modelName = '商品分类';
    ...
    public function view(Authenticatable $user, ProductCategory $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
    ...
    public function update(Authenticatable $user, ProductCategory $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }

    #[PolicyName('删除', type: PolicyType::Button)]
    public function delete(Authenticatable $user, ProductCategory $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
    ...
    public function upgradeSort(Authenticatable $user, ProductCategory $record): bool
    {
        return $user->hasPermission(__CLASS__, __FUNCTION__);
    }
}
