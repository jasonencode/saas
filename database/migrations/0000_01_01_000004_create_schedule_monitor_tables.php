...
class CreateScheduleMonitorTables extends Migration
{
    ...
    {
        Schema::create('monitored_scheduled_tasks', static function(Blueprint $table) {
        ...
        Schema::create('monitored_scheduled_task_log_items', static function(Blueprint $table) {
            $table->bigIncrements('id');

            $table->unsignedBigInteger('monitored_scheduled_task_id');
            $table->foreign('monitored_scheduled_task_id', 'fk_scheduled_task_id')
                ->references('id')
